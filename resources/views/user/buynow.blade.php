...
<div class="container">
    ...
    <table>
        ...
        @foreach ($product as $products)
            ...
            <tr>
                <td>{{ $products->name }}</td>
                <td><img src="{{ asset('uploads/' . $products->image) }}" alt="{{ $products->productname }}" class="product-image"></td>
                <td>
                    <div class="input-group">
                        <input type="text" class="form-control" id="quantity_{{ $products->id }}" value="{{ $quantity }}" readonly>
                    </div>
                </td>
            ...
            if (name && address && state && city && pincode && mobile && mobile&& pincode) {
                ...
                var options = {
                    ...
                    "handler": function (response) {
                        ...
                        $j.ajax({
                            url: "{{ route('buynowpayment.process') }}",
                            type: "POST",
                            headers: {
